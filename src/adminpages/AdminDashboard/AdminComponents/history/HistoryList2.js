...
export default function Historylist2() {
  ...
  const editData = (id, firstName, lastName, middleName, Email, StudentNumber, ContactNumber, CurrentCollege, CurrentYear, ClassificationConcern, NatureConcern, Concern) => {
    const data = {
      id: id, 
      firstName: firstName,
      lastName: lastName,
  ...
  return (
    ...
    <Paper sx={{ width: '100%', overflow: 'hidden' }}>
      ...
      <TableContainer sx={{ maxHeight: 300, maxWidth: 1500 }}>
                        ...
                        <TableCell align="left">
                          <Stack spacing={2} direction="row">
                            <EditIcon
                              ...
                              onClick={() => {
                                editData(row.Status, row.firstName,row.lastName,row.middleName,row.Email,row.StudentNumber,row.ContactNumber,row.CurrentCollege,row.CurrentYear,row.ClassificationConcern,row.NatureConcern,row.Concern);
                              }}
